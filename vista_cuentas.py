...
class index:
    ...
    def dibuja_creacuentas(self):
        self.cuenta = Creacioncuentas(self.ventana_cuentas, self.id_usuario)
        return self.cuenta

class Creacioncuentas:    
    def __init__(self,ventanaprincipal,id_usuario):
        """
    ...
    def verifica_contra(self):
        ...
        if registra_pwwd == confirma_pwwd:
            self.cuenta_nueva = cuenta(self.id_usuario,registra_sitio,registra_url,registra_login,registra_pwwd).crear_cuenta()
